                                ...
                                <div class="col-lg-10">
                                    <div class="selectgroup selectgroup-pills">
                                        <label class="selectgroup-item">
                                            <input type="radio" name="kategori_usulan" value="all" class="selectgroup-input" checked="" onclick="get_data_peraturan()">
                                        ...
                                        ?>
                                            <label class="selectgroup-item">
                                                <input type="radio" name="kategori_usulan" value="<?php echo encrypt_data($value->id_kategori_usulan); ?>" class="selectgroup-input" onclick="get_data_peraturan()">
                                                <span class="selectgroup-button selectgroup-button-icon"> <?php echo $value->nama_kategori ?></span>
                                            </label>
                                        <?php
                                        }
                                        ?>
                    ...
                    <div class="card">
                        <div class="card-header d-block">
                            ...
                            <div class="card-header-action text-right">
                                <a href="#kirimFileKeProvinsi" onclick="lampiran_provinsi()" class="btn btn-warning"><i class="ion ion-ios-paper"></i> Upload Lampiran Untuk Provinsi</a>
...
<div id="showChangeDate" class="modal" tabindex="-1" role="dialog">
            ...
            <div class="modal-body">
                <div class="form-group row">
                    ...
                    <div class="col-lg-10">
                        ...
                        <input type="hidden" name="id_change_date" />
                    </div>
                </div>
            </div>
            <div class="modal-footer">
                <button type="submit" class="btn btn-primary" onclick="save_date_transaksi()">Simpan</button>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group row">
                    ...
                    <div class="col-lg-10">
                        <input type="file" class="form-control" name="lampiran_provinsi" accept="application/pdf,application/msword,application/vnd.openxmlformats-officedocument.wordprocessingml.document">
...
<script>
                ...
                success: function(response) {
                    ...
                    $.each(response, function(index, value) {
                        html += "<div class='activity'>" +
                            ...
                            "<div class='mb-2'>" +
                            "<span class='text-job' onClick=\"show_date('"+value.id_trx_raperbup+"')\">" + value.tanggal_custom + "</span>" +
    ...
    function show_date(id){
        $.ajax({
            url: base_url + 'monitoring_raperbup/request/get_trx_raperbup',
            data: {
                id: id
            },
            type: 'GET',
            ...
            success: function(response) {
                $("#showChangeDate").modal("show");
                $("input[name='id_change_date']").val(id);
    ...
    function save_date_transaksi(){
        let tanggal = $("input[name='tanggal']").val();
        let id = $("input[name='id_change_date']").val();
        let id_peraturan = $("input[name='usulan_peraturan']").val();
        $.ajax({
            url: base_url + 'monitoring_raperbup/save_date_transaksi',
            data: {
                id: id,
                tanggal: tanggal,
            },
            ...
            success: function(response) {
                $("#showChangeDate").modal("toggle");
                $("input[name='id_change_date']").val("");
                show_detail_peraturan(id_peraturan);
                if (response) {
                    swal('Berhasil', 'Tanggal berhasil diubah', 'success');
                } else {
                    swal('Gagal', 'Tanggal tidak bisa diubah', 'error');
                }
            },
            complete: function(response) {
                HoldOn.close();
