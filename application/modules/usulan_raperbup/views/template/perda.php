...
<head>
    <meta charset="UTF-8">
    <title>Peraturan Daerah Katingan</title>
    <style>
        body {
    ...
    <div class="content">
        ...
        <div class="centered-title-container">
            <div class="centered-title-content">
                <p style="margin: 0;">Dengan Persetujuan Bersama</p>
                <p style="margin: 0;">DEWAN PERWAKILAN RAKYAT DAERAH KABUPATEN KATINGAN</p>
                <p style="margin: 0;">dan</p>
                <p style="margin: 0;">BUPATI KATINGAN</p>
            </div>
        </div>
            ...
            <table style="border: none;">
                <tr>
                    <td style="border: none;">
                        ...
                        <br>
                        <p style="margin: 0 0; text-transform: uppercase; text-align: center;">
                            LEMBARAN DAERAH KABUPATEN KATINGAN TAHUN 2026 NOMOR
                        </p>
                        <p style="margin: 0 0; text-transform: uppercase; text-align: center;">
                            NOMOR REGISTER PERATURAN DAERAH KABUPATEN KATINGAN, PROVINSI KALIMANTAN TENGAH :
                        </p>
                    </td>
                </tr>
            </table>
        ...
        <!-- Penjelasan (jika ada) - HALAMAN TERPISAH -->
        <?php if (!empty($penjelasan)): ?>
            <!-- Page break untuk membuat halaman baru -->
            <div style="page-break-before: always;"></div>

            <!-- Judul Penjelasan rata tengah dari konten -->
            <div class="centered-title-container" style="margin: 0 !important;">
                <div class="centered-title-content">
                    <p style="margin:0;">PENJELASAN</p>
                    <p style="margin:0;text-transform: uppercase;">ATAS</p>
                    <p style="margin:0;text-transform: uppercase;">RANCANGAN PERATURAN DAERAH KABUPATEN KATINGAN</p>
                    <p style="margin:0;text-transform: uppercase;">NOMOR&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;TAHUN 2026</p>
                    <p style="margin:0;text-transform: uppercase;">TENTANG <br> <?php echo htmlspecialchars($nama_peraturan); ?></p>
                </div>
            </div>

            <div class="menimbang-section">
                <div class="menimbang-content" style="text-indent: 2em;">
                    <?php echo $penjelasan; ?>
                </div>
            </div>
        <?php endif; ?>
